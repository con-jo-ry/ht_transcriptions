...
$comparison5 = $upama->compare('temp.htec.txt','temp.htk.txt', '');
$comparison6 = $upama->compare('temp.htec.txt','temp.htet.txt', '');
$comparison7 = $upama->compare('temp.htec.txt','temp.htes.txt', '');

$collation = $upama->collate([$comparison1,$comparison2,$comparison3,$comparison4,$comparison5,$comparison6,$comparison7]);
